Public Class FrmRep_Dev_Comp
    Dim tabla_ListarDevComp As DataTable
    Public Sub listar_Dev_Comp(
        ...
        If servidor.abrirconexion = True Then
            ...
            tabla_ListarDevComp = servidor.consultar("[dbo].[Rep_Listar_Devolucion_Comp_de_Pago]", _
                                       _Fecha_Ing_Ini, _
                                       _Fecha_Ing_Fin, _
                                       _Comisionista, _
                                       _Remitente, _
            ...
            If tabla_ListarDevComp Is Nothing Then
                __mesajeerror = servidor.getMensageError
                servidor.cerrarconexion()
                MessageBox.Show(__mesajeerror, "Guía de Remisión – Remitente", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                Dim NroFilas As Integer = tabla_ListarDevComp.Rows.Count
                If NroFilas = 0 Then
                    servidor.cerrarconexion()
                    dgvlista.DataSource = tabla_ListarDevComp
                ...
                Else
                    dgvlista.DataSource = tabla_ListarDevComp
                    servidor.cerrarconexion()
                    mesajeerror.Text = "Guía de Remisión – Remitente Tiene " + NroFilas.ToString + " Devolucion(ES) de Comprobantes de Pago"
                ...
                End If
                dgvlista.Columns("Id_Detalle_Dev_Comp").Visible = False
                dgvlista.Columns("Id_Devolucion_Comp").Visible = False
    ...
    End Sub
    Private Sub FrmRep_Dev_Comp_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        ...
        f.Titulo_Informe = "REPORTE DE DEVOLUCIONES DE COMPROBANTES DE PAGO"
        f.ShowDialog()
    End Sub
End Class