Public Class FrmListar_Operacion_Sal
    ...
    Public Sub lista(ByVal Tipo_Operacion As Integer, ByVal Criterio As String)
        ...
        If servidor.abrirconexion = True Then
            If servidor.consultar("[dbo].[pa_Listar_Operacion_Salida]", Tipo_Operacion, Criterio).Tables.Count > 0 Then
                tabla_Operacion = servidor.consultar("[dbo].[pa_Listar_Operacion_Salida]", Tipo_Operacion, Criterio).Tables(0)
            End If
        ...
        End If
    End Sub
    Private Sub FrmListar_Operacion_Sal_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmListar_Operacion_Sal_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
