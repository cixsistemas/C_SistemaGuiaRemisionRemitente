Public Class FrmDev_Comp1
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        Else
            If MessageBox.Show("¿Desea eliminar el detalle Devolucion?", "Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim servidor As New clinicapacifico.clsaccesodatos
                servidor.cadenaconexion = Ruta
    ...
    Private Sub TxtDistrito_Enter(sender As Object, e As EventArgs) Handles TxtDistrito.Enter
        ...
        Catch ex As Exception
            MessageBox.Show("Seleccione Distrito a Buscar", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End Try
    End Sub
