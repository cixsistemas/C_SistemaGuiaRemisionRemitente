Public Class FrmPeso_Med2
        ...
        If servidor.abrirconexion = True Then
            ...
            Else
                ...
                Else
                    ...
                    'mesajeerror.Text = "Sistema tiene " + NroFilas.ToString + " Constancia(s) de Verificacion de Pesos y Medidas"
                    mesajeerror.Text = ""
                End If
                servidor.cerrarconexion()
            End If
    ...
    Private Sub FrmPeso_Med22_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub FrmPeso_Med22_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnNuevo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnNuevo.Click
        ...
        If formulario.Aceptar = True Then
            If MessageBox.Show("¿Desea guardar Constancia de Verificacion de Pesos y Medidas?", "Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                Dim servidor As New clinicapacifico.clsaccesodatos
                servidor.cadenaconexion = Ruta
                If servidor.abrirconexiontrans = True Then 'abrimos conección y iniciamos transacción.
                    ...
                    servidor.ejecutar("[dbo].[pa_mantenimiento_peso_med]",
                    False,
                    rpta,
                    mensaje,
                    formulario.Id_peso_med,
                    formulario.Id_guia,
                    formulario.fecha_emision_guia.Value,
                    formulario.observacion.Text.Trim,
                    "N",
                    0, "")
                    If rpta > 0 Then
    ...
    Private Sub btnEliminar_Click_1(ByVal sender As Object, ByVal e As EventArgs) Handles btnEliminar.Click
        If (indice = -1) Then
            MessageBox.Show("Seleccione Constancia de Verificacion de Pesos y Medidas", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If


        If MessageBox.Show("¿Desea eliminar Constancia de Verificacion de Pesos y Medidas?", "Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            Dim servidor As New clinicapacifico.clsaccesodatos
            servidor.cadenaconexion = Ruta
            If servidor.abrirconexiontrans = True Then
                ...
                servidor.ejecutar("[dbo].[pa_mantenimiento_peso_med]",
                  ...
                  rpta,
                  mensaje,
                  CInt(dgvlista.Item("Id Peso Medida", indice).Value),
                  Nothing,
                  Nothing,
                  Nothing,
                 "E",
