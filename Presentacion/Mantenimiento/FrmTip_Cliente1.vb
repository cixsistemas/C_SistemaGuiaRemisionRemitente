Public Class FrmTip_Cliente1
    ...
    Private Sub FrmTip_Cliente1_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    End Sub
    Private Sub FrmTip_Cliente1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
