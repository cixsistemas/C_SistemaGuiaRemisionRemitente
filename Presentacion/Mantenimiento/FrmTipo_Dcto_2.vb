Public Class FrmTipo_Dcto_2
    ...
    Private Sub FrmTipo_Dcto_2_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles Me.FormClosed
        Aceptar = False
        Hide()
    End Sub
    ...
    Private Sub TxtCodigo_VisibleChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TxtCodigo.VisibleChanged
        valida()
    End Sub
    Private Sub FrmTipo_Dcto_2_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
