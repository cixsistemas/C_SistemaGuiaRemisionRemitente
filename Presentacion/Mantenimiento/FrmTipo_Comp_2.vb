Public Class FrmTipo_Comp_2
    ...
    Private Sub BtnAceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnAceptar.Click
        ...
        ok = TxtNombre.Text <> ""
        If (ok = False) Then
            MessageBox.Show("Ingrese Tipo de Comprobante de Pago por favor.", "Guía de Remisión – Remitente", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TxtNombre.Focus()
            Exit Sub
        End If
        ...
        'Aceptar = True
        'Hide()
        If MessageBox.Show("¿DESEA " + IIf(Nivel = "N", "GUARDAR ", "MODIFICAR ") + " Tipo de Comprobante de PAgo?", "Guía de Remisión – Remitente", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
