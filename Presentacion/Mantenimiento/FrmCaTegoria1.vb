Public Class FrmCaTegoria1
    ...
    Private Sub FrmCaTegoria11_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Aceptar = False
        Hide()
    End Sub
    ...
    Private Sub precio_cat_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles precio_cat.TextChanged
        valida()
    End Sub

    Private Sub precio_cat_VisibleChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles precio_cat.VisibleChanged
        valida()
    End Sub
    ...
    Private Sub nombre_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles nombre.KeyPress
        ...
        saltar_ENTER(e)
    End Sub
    Private Sub precio_cat_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles precio_cat.KeyPress
        saltar_ENTER(e)
    End Sub
    ...
    End Sub
    Private Sub precio_cat_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles precio_cat.Enter
        precio_cat.BackColor = Color.Moccasin
    End Sub
    Private Sub precio_cat_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles precio_cat.Leave
