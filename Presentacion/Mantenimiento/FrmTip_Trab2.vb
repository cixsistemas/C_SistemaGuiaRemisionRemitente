Public Class FrmTip_Trab2
        ...
        If servidor.abrirconexion = True Then
            ...
            Else
                ...
                Else
                    ...
                    mesajeerror.Text = "Guía de Remisión – Remitente tiene " + NroFilas.ToString + " Tipo(s) de Trabajador(es)"
                End If
                servidor.cerrarconexion()
            End If
        Else
    ...
    Private Sub FrmTip_Trab22_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnmodificar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnModificar.Click
        If (indice = -1) Then
            MessageBox.Show("Seleccione Tipo de Trabajador", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
