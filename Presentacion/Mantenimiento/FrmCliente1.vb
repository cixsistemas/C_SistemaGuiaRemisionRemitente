Public Class FrmCliente1
    ...
    Private Sub FrmCliente1_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles Me.FormClosed
        Aceptar = False
        Hide()
    End Sub
    ...
    Private Sub FrmCliente1_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub FrmCliente1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnTipo_Cliente_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnTipo_Cliente.Click
        Try
...
#Region "Text Box"
    ...
    Private Sub txtDescrip_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txtDescrip.KeyDown
        saltar_Flechas(e)
    End Sub
    Private Sub txtLinea_Credito_Enter(ByVal sender As Object, ByVal e As EventArgs) Handles txtLinea_Credito.Enter
