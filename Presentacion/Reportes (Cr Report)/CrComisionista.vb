...
Public Class CrComisionista
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrComisionista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrComisionista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrComisionista = New CrComisionista()
        rpt.Site = Site
        Return rpt
    End Function
