...
Public Class CrRep_Ing_comp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Ing_comp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Ing_comp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Ing_comp = New CrRep_Ing_comp()
        rpt.Site = Site
        Return rpt
    End Function
