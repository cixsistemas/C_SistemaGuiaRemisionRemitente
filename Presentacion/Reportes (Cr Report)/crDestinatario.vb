...
Public Class crDestinatario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.crDestinatario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDestinatario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDestinatario = New crDestinatario()
        rpt.Site = Site
        Return rpt
    End Function
