...
Public Class CrPes_Med_Zelu
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrPes_Med_Zelu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPes_Med_Zelu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPes_Med_Zelu = New CrPes_Med_Zelu()
        rpt.Site = Site
        Return rpt
    End Function
