...
Public Class CrRep_Fle_Transp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Fle_Transp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Fle_Transp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Fle_Transp = New CrRep_Fle_Transp()
        rpt.Site = Site
        Return rpt
    End Function
