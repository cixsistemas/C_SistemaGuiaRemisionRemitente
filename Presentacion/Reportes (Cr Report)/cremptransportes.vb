...
Public Class cremptransportes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.cremptransportes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcremptransportes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cremptransportes = New cremptransportes()
        rpt.Site = Site
        Return rpt
    End Function
