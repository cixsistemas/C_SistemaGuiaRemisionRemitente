...
Public Class CrRep_Ventas_Rem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Ventas_Rem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Ventas_Rem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Ventas_Rem = New CrRep_Ventas_Rem()
        rpt.Site = Site
        Return rpt
    End Function
