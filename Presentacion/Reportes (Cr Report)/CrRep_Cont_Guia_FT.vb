...
Public Class CrRep_Cont_Guia_FT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Cont_Guia_FT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Cont_Guia_FT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Cont_Guia_FT = New CrRep_Cont_Guia_FT()
        rpt.Site = Site
        Return rpt
    End Function
