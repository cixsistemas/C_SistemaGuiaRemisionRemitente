...
Public Class CrRep_Env_comp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Env_comp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Env_comp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Env_comp = New CrRep_Env_comp()
        rpt.Site = Site
        Return rpt
    End Function
