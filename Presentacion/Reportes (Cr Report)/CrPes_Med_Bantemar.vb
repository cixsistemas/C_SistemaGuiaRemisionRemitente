...
Public Class CrPes_Med_Bantemar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrPes_Med_Bantemar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPes_Med_Bantemar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPes_Med_Bantemar = New CrPes_Med_Bantemar()
        rpt.Site = Site
        Return rpt
    End Function
