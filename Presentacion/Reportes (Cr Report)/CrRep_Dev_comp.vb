...
Public Class CrRep_Dev_comp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrRep_Dev_comp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrRep_Dev_comp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRep_Dev_comp = New CrRep_Dev_comp()
        rpt.Site = Site
        Return rpt
    End Function
