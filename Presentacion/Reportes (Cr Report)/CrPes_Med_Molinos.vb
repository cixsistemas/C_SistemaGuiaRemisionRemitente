...
Public Class CrPes_Med_Molinos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.CrPes_Med_Molinos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPes_Med_Molinos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPes_Med_Molinos = New CrPes_Med_Molinos()
        rpt.Site = Site
        Return rpt
    End Function
